...
def text2htmls(chap_name: str, text: str) -> str:
...
def get_toc_html(title: str, chap_names: list[str]) -> str:
...
def replace_rubbish_text(content_html: str) -> str:
